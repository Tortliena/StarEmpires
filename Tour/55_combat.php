...
$reqinfopvvaisseau = $bdd->prepare("    SELECT cv.idtable, c.degatpartir, cv.tirrestant, v.idvaisseau, v.HPvaisseau, v.idflottevaisseau
                                        FROM gamer.vaisseau v
                                        LEFT JOIN  gamer.composantvaisseau cv ON v.idvaisseau = cv.idvaisseaucompo
                                        LEFT JOIN composant c ON cv.iditemcomposant = c.idcomposant
