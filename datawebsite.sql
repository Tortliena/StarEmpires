...
(1, 'Centre de recherche', 60, 0, 'batiments', 1, 0, 'Peut accueillir jusqu\'à 5 chercheurs.', 'maxcentrederecherche', ''),
(2, 'Chantier', 50, 0, 'batiments', 3, 0, 'Peut accueillir jusqu\'à 5 ouvriers.', 'maxchantier', ''),
(3, 'Mégalopole', 80, 0, 'batiments', 0, 0, 'Permet d\'augmenter la population maximale d\'une planète.', 'maxmegalopole', ''),
(4, 'Base lunaire', 150, 10, 'batiments', 2, 0, 'Permet d\'augmenter la population maximale de notre civilisation.', 'maxbaselunaire', ''),
...
INSERT INTO `recherche` (`idrecherche`, `nomrecherche`, `descriptionrecherche`, `prixrecherche`, `itemnecessaire`, `recherchenecessaire`) VALUES
(1, 'Centre de recherche', 'Vous permet de construire un centre de recherche qui va vous permettre d\'augmenter la limite maximale du nombre de chercheurs.', 3, 0, 4),
