...
$reqvaleurpossibleprochainevent = $bdg->prepare('SELECT	eventsuite1, eventsuite2, eventsuite3 FROM choixevents WHERE idjoueurevent = ?');
...
if ($_POST['choix'] == $repvaleurpossibleprochainevent['eventsuite1'] OR $_POST['choix'] == $repvaleurpossibleprochainevent['eventsuite2'] OR $_POST['choix'] == $repvaleurpossibleprochainevent['eventsuite3'])
	...
	$reqchangerevent = $bdg->prepare('UPDATE utilisateurs SET ideventsuivant = ? WHERE id = ?');
